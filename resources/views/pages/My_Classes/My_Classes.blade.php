...
@section('content')
    ...
    <h3>{{ trans('My_Classes_trans.title_page') . " :" }}</h3>

    <div class="row ">
        <div class="col-xl-12 mb-30 table-responsive">
            <div class="card card-statistics h-100 table-responsive">
                {{--        <h2 style="position: absolute;left:0">{{ trans('My_Classes_trans.title_page') }}</h2>--}}
                                                ...
                                                <form action="{{ route('Classrooms.update', 'test') }}"
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            ...
                                                            :</label>
                                                        <select style="height: calc(4.1rem + 2px) !important;"
                                                ...
                                                <div class="col" style="margin: 20px">
                                                    <div class="box">
                                                        <select class="fancyselect" name="Grade_id">
                                                            <option value="">أختر أسم المرحله</option>
                                                            @foreach ($Grades as $Grade)
