                            ...
                            <div class="row" style="margin: 20px 0">
                                ...
                                <div class="col-md-4 image" style="overflow: hidden">
                                    <img style="   width: 80%;  height: 70%;"
                                         src="{{asset('assets/images/vison.png')}}">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <ul>
                                        @foreach($student->problems as $index=> $problem)
                                            <form method="POST" action="{{ route('Students.problemsDelete',$student->id) }}"
                                                  autocomplete="off"
                    ...
                    <div class="addProblem">
                        ...
                        <form method="POST" action="{{ route('updateProblems',$student->id) }}" autocomplete="off"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="height: 50px" class="custom-select mr-sm-2 form-control"
                                            ...
                                            @foreach($levels as $level)
                                                <option
                                                    value="{{ $level->id }}" {{ $student->levil_id == $level->id ? 'selected' : ''  }}
                                                >{{ $level->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Classroom_id">الاجراءات : <span class="text-danger">*</span></label>
                                        <select style="height: 50px" class="custom-select mr-sm-2 form-control"
                                                name="problem_id">
                                ...
                                <div class="col-md-12">
                                    <label for="title">تفاصيل الاجراء :</label>
