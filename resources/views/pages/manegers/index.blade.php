                ...
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        ...
                        @endif
                                ...
                                <a href="{{route('manger.send')}}" class="btn btn-success btn-lg my-2" role="button"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('manger.destroy',$note->id)}}"
                                                                ...
                                                                <input type="text" class="form-control" name="id" value="{{$note->title}}">


                                                                <div class="modal-footer">

                                                                    <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">{{trans('Students_trans.Close')}}
                                                                    </button>
                                                                    <button
                                                                        class="btn btn-danger">{{trans('Students_trans.submit')}}
                                                                    </button>
