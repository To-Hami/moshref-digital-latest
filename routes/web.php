...
/*********************  grades ********************************/
    ...
    Route::group(['namespace' => 'Classrooms'], function () {
        ...
        Route::resource('mograrats', 'MograratController');
        Route::get('mograrat/trash', 'MograratController@trash')->name('mograrats.trash');
        Route::get('mograrat/createExcel', 'MograratController@createExcel')->name('mograrats.createExcel');
        Route::post('mograrat/storeExcel', 'MograratController@storeExcel')->name('mograrats.storeExcel');
        Route::get('mograrat/add_studant', 'MograratController@addStudant')->name('mograrats.addStudant');
...
//Route::get('studants/data' , 'StudentController@data')->name('studants.data');
        ...
        Route::post('/Students/problems/{id}/delete', 'StudentController@StudentProblemsDelete')->name('Students.problemsDelete');
    ...
    Route::post('get/search', 'Students\StudentController@getSearch')->name('getSearch');
});
